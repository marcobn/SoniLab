...
,
		"classnamespace" : "box",
		"rect" : [ 1597.0, 253.0, 1308.0, 844.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 316.0, 255.0, 60.0, 23.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 321.0, 366.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 317.0, 294.0, 64.0, 23.0 ],
					"text" : "qmetro 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 321.0, 333.0, 75.0, 23.0 ],
					"text" : "adstatus cpu"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 735.0, 276.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 62.0, 417.0, 48.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 62.0, 380.0, 105.625, 23.0 ],
					"text" : "mc.pack~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 62.0, 349.0, 134.5, 23.0 ],
					"text" : "matrix~ 12 4 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 665.0, 598.0, 92.0, 23.0 ],
					"text" : "mc.dac~ 5 6 7 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 632.0, 92.0, 23.0 ],
					"text" : "mc.dac~ 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 83.0, 148.0, 79.0, 23.0 ],
					"text" : "poly~ CP_3 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 72.5, 115.0, 79.0, 23.0 ],
					"text" : "poly~ CP_2 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 62.0, 81.0, 79.0, 23.0 ],
					"text" : "poly~ CP_1 6"
				}
